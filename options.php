...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __( 'Socail Media', 'theme-textdomain' ),
		'type' => 'heading'
	);
/*
	$options[] = array(
...
*/
	$options[] = array(
		...
		'desc' => __( 'This is my facebook page.', 'theme-textdomain' ),
		'id' => 'pixelico_facebook_link',
		'placeholder' => $social_defaults['facebook'],
		'type' => 'text'
	);

	$options[] = array(
		'name' => __( 'Youtube Channel', 'theme-textdomain' ),
		'desc' => __( 'This is my youtube channel.', 'theme-textdomain' ),
		'id' => 'pixelico_youtube_channel',
		'placeholder' => $social_defaults['youtube'],
		'type' => 'text'
	);

	$options[] = array(
		'name' => __( 'Googel Plus Link', 'theme-textdomain' ),
		'desc' => __( 'This is my google-plus link.', 'theme-textdomain' ),
		'id' => 'pixelico_google_plus_link',
		'placeholder' => $social_defaults['google-plus'],
		'type' => 'text'
	);

	$options[] = array(
		'name' => __( 'Instagram Link', 'theme-textdomain' ),
		'desc' => __( 'This is my instagram link.', 'theme-textdomain' ),
		'id' => 'pixelico_instagram_link',
		'placeholder' => $social_defaults['instagram'],
		'type' => 'text'
	);

	$options[] = array(
		'name' => __( 'Twitter Link', 'theme-textdomain' ),
		'desc' => __( 'This is my twitter link.', 'theme-textdomain' ),
		'id' => 'pixelico_twitter_link',
		'placeholder' => $social_defaults['twitter'],
		'type' => 'text'
	);
/*
	$options[] = array(
...
*/
	$options[] = array(
		'name' => __( 'Update Logo Image', 'theme-textdomain' ),
