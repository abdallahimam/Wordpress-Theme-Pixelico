...
if ( ! class_exists( 'WPEX_Theme_Options' ) ) {
	class WPEX_Theme_Options {
         ...
         */
        public static function add_background_section() {
            // code...
        }
         ...
         * Add fonts section.
         */
        public static function add_fonts_section() {
            // code...
        }
         ...
         * Add social section.
         */
        public static function add_social_section() {
            // code...
        }
			...
			<div class="wrap">
				...
				<form method="post" action="options.php">
					...
					<table class="form-table wpex-custom-admin-login-table">
						...
						<tr valign="top">
							<th scope="row"><?php esc_html_e( 'Logo Image', 'text-domain' ); ?></th>
							<td>
								<?php $value = self::get_theme_option( 'logo_image' ); ?>
								<input type="checkbox" name="theme_options[logo_image]" <?php checked( $value, 'on' ); ?>> <?php esc_html_e( 'Logo image description.', 'text-domain' ); ?>
							</td>
						</tr>
