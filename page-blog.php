			...
			<div class="row">
				<div class="col-md-8">
					...
					<?php endwhile; wp_reset_postdata(); else : ?>
						<p class="d-block w-100 text-center">Sorry, no posts yet.</p>
					<?php endif; ?>
				</div>
				<div class="col-md-4">
						...
						<div class="widgets">
							<div class="widget">
								...
								<div class="widget-body">
									<?php
									$latest_downloads = new WP_Query(
										array(
											'numberposts' => '5',
											'posts_per_page' => 5,
											'meta_key' => 'wpb_post_downloads_count',
											...
											<li class="row popular-post mb-3">
												...
												<div class="col-6 p-0">
													<a target="_blank" href="<?php echo get_permalink($post['ID']) ?>" class="d-block w-100 h-100 py-4 px-2">
														...
														<p>Added on <span><?php the_time('F j, Y', $post['ID']); ?></span></p>
													</a>
												</div>
											</li>
										<?php endwhile; ?>
